...
const Navbar: React.FC<NavbarProps> = ({activeSection, showNavbar, showMobileMenu, setShowMobileMenu}) => {
  return (
    <nav className={`fixed top-0 z-50 w-full h-16 border-b border-b-zinc-800 bg-zinc-900 text-zinc-400 ${showNavbar && "show"}`}>
      <div className="container h-full flex items-center justify-between">
        <a href="#start" className="pt-1" style={{fontFamily: "Playwrite BR"}} onClick={() => setShowMobileMenu(false)}>Lucca Lazzarini Silva</a>
